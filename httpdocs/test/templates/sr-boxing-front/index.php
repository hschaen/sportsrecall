          ...
          <div id="main_component" >
            ...
            <div class="main-content">
              ...
              <!--  MAIN COMPONENT -->
                            ...
                            <div class="boxing_front">

<!--  SR BOXING -->

                            <div class="boxing_front">

							<div><h1>BOXING</h1></div>

                             <div><jdoc:include type="modules" name="boxing_featuredvideos" /></div>

                            <div><jdoc:include type="modules" name="boxing_menu" />
                              <a href="/test/boxing-mens">Mens</a> - <a href="/test/boxing-womens">Womens</a></div>

<hr>

                            <div id="boxing_cat" ><h2>CATEGORIES</h2><jdoc:include type="modules" name="boxing_categories"  /></div>

                            <div id="boxing_wdyt" ><h2>WHAT DO YOU THINK?</h2><jdoc:include type="modules" name="boxing_poll" style="joomspirit" /></div>

                            <div id="boxing_rel" ><h2>RELATED TOPICS</h2><jdoc:include type="modules" name="boxing_related" style="joomspirit" /></div>

                            <div id="boxing_search" ><h2>SEARCH BY NAME:</h2><jdoc:include type="modules" name="boxing_search" style="joomspirit" /></div>

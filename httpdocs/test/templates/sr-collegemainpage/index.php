...
while($row = mysqli_fetch_array($result))
  {
  echo $row['SchoolName']. ' - ' . $row['Initials'].' - '. $row['Name'];
  }
mysqli_close($con);
?></h1>
                            </div>
...
if ($row = mysqli_fetch_array($result)){ 
  ...
  echo '<table cellspacing="0" cellpadding="0" border="0" width="100%"><tr><td valign="top"><table cellpadding="0" cellspacing="0" width="200" border="0"><tr><td height="188" bgcolor="#000000" valign="middle">' . $row['EmbedURL'] . '</td></tr><tr><td>' . $row['Title'] . '</td></tr></table></td>';
	  ...
	  echo '<table cellspacing="0" cellpadding="0" border="0" width="100%"><tr><td valign="top"><table cellpadding="0" cellspacing="0" width="235" border="0"><tr><td height="188" bgcolor="#000000" valign="middle"><img src="http://sportsrecall.com/test/images/up1.jpg"></tr></td></table></td>';
  }
  ...
  echo '<td valign="top"><table cellpadding="0" cellspacing="0" width="200" border="0"><tr><td height="188" valign="middle" bgcolor="#000000">' . $row['EmbedURL'] . '</td></tr><tr><td>' . $row['Title'] . '</td></tr></table></td></tr></table>';
	  ...
	  echo '<td valign="top"><table cellpadding="0" cellspacing="0" width="235" border="0"><tr><td height="188" bgcolor="#000000" valign="middle"><img src="http://sportsrecall.com/test/images/up2.jpg"></td></tr></table></td></tr></table>';
  }
...
while ($row = mysqli_fetch_array($result)) {
  ...
  <h2>Women</h2><ul class="collegesportslist">';
      if ($row['ACROBATICSTUMBLING'] == '0') 
		...
		session_start();
        $sports = $row['ACROBATICSTUMBLING'];
		echo '<li class="collegesportlist"><form action="index.php?option=com_content&view=article&id=1136&Itemid=1257&college='.$row['SchoolName'].'&sport=' . $sports . '" method="post">';
		echo '<a onClick="submit()">' . $sports . '</a></form></li>';
        }
...
<div class="rep" >
  ...
  <p><a href="http://www.sportsrecall.com/contactus"><img src="http://www.sportsrecall.com/test/images/rep.jpg" width="250" height="174" alt="Rep Your School!" /></a></p>
...
while($row = mysqli_fetch_array($result))
  ...
  echo "<a href='http://" . $row['WebsiteSchoolURL'] . "'>" . $row['WebsiteSchoolURL'] .  "</a>\n<br>";
		  }
		    if ($row['WebsiteSportsURL'] == '0') {
		  }
		  else {
  echo "<a href='http://" . $row['WebsiteSportsURL'] . "'>" . $row['WebsiteSchoolURL'] .  "</a>\n<br>";
		  } 
		  if ($row['Youtube'] == '0') {
		  }
		  else { echo "<a href='http://www.youtube.com/" . $row['Youtube'] . "'>youtube.com/" . $row['Youtube'] .  "</a>\n<br>"; 
		  }
		  if ($row['TwitterMain'] == '0') {
		  }
		  else { echo "<a href='http://www.twitter.com/" . $row['TwitterMain'] . "'>twitter.com/" . $row['TwitterMain'] .  "</a>\n<br>";}
		  if ($row['TwitterAlt'] == '0') {
		  }
		  else { echo "<a href='http://www.twitter.com/" . $row['TwitterAlt'] . "'>twitter.com/" . $row['TwitterAlt'] .  "</a>\n<br>"; } 
		  if ($row['FacebookMain'] == '0') {
		  }
		  else { echo "<a href='http://www.facebook.com/" . $row['FacebookMain'] . "'>facebook.com/" . $row['FacebookMain'] .  "</a>\n<br>"; }
		  if ($row['FacebookSports'] == '0') {
		  }
		  else { echo "<a href='http://www.facebook.com/" . $row['FacebookSports'] . "'>facebook.com/" . $row['FacebookSports'] .  "</a>\n<br>";
  }
		  }
mysqli_close($con);
?>

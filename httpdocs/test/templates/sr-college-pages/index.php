...
$con=mysqli_connect("sRECALLlocalhost","sRECALL013test","Tgcstudios24!","sRECALL013test");
// Check connection
...
?></h1>
                            ...
                            <div><jdoc:include type="modules" name="school_video" style="joomspirit" /></div>
                            <div><jdoc:include type="modules" name="school_name" style="joomspirit" /></div>
<hr>
                            <div><jdoc:include type="modules" name="school_videos" style="joomspirit" /></div>
                            <hr>
<div class="mens" >
  <h2>Mens Sports </h2>
  <jdoc:include type="modules" name="men_sports" style="joomspirit" />
</div>

<div class="womens" >
  <h2>Womens Sports </h2>
    <jdoc:include type="modules" name="women_sports" style="joomspirit" />
</div>
...
<div class="more" >
  <h2>More </h2>
    <jdoc:include type="modules" name="more" style="joomspirit" />
...
<div class="rep" >
  <h2>Rep Your School!
    <jdoc:include type="modules" name="rep_school" style="joomspirit" />
  </h2>
  <p>If you want to be your school's rep click <a href="#">HERE</a></p>
</div>
<hr><div class="links" >
  <h2>School's official links</h2>
  <jdoc:include type="modules" name="school_links" style="joomspirit" />
  <p>&nbsp;</p>
</div>

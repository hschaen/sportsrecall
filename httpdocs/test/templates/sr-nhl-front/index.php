...
* @copyright  Copyright (C) 2013 sr. All rights reserved.
            ...
            <div class="main-content">
              ...
              <!--  MAIN COMPONENT -->
							...
							<div><h1>HOCKEY</h1></div>
                             ...
                             <div><jdoc:include type="modules" name="nhl_team_featuredvideos" /></div>
                             
                             <div><h2>TEAMS</h2><jdoc:include type="modules" name="nhl_menu" /></div>

<hr>

                            <div id="nhl_cat" ><h2>CATEGORIES</h2><jdoc:include type="modules" name="nhl_categories"  /></div>

                            

                            <div id="nhl_rel" ><h2>RELATED TOPICS</h2><jdoc:include type="modules" name="nhl_related" style="joomspirit" /></div>
